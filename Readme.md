...
Github has a 2 GB file size limit for release artefacts. Unfortunately, the RedStarOS 3.5 modded ISO is way too big to fit within that limit. Split 7z archives were used to get around this limitation. 
